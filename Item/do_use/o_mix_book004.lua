...
if (b>=1) then
	AddMenuItem("@22级肉可合成花灵露("..b..")个","nc_combine o_mix_book004 b","花灵露合成")
	else
	AddMenuItem("2级肉可合成花灵露(0)个","nc_combine o_mix_book004 h","花灵露合成")
end
if (c>=1) then
	AddMenuItem("@23级肉可合成花灵露("..c..")个","nc_combine o_mix_book004 c","花灵露合成")
	else
	AddMenuItem("3级肉可合成花灵露(0)个","nc_combine o_mix_book004 h","花灵露合成")
end
if (d>=1) then
	AddMenuItem("@24级肉可合成花灵露("..(d*3)..")个","nc_combine o_mix_book004 d","花灵露合成")
	else
	AddMenuItem("4级肉可合成花灵露(0)个","nc_combine o_mix_book004 h","花灵露合成")
end
if (e>=1) then
	AddMenuItem("@25级肉可合成花灵露("..(e*9)..")个","nc_combine o_mix_book004 e","花灵露合成")
	else
	AddMenuItem("5级肉可合成花灵露(0)个","nc_combine o_mix_book004 h","花灵露合成")
end
--if (b>=1 or c>=1 or d>=1 or e>=1) then
--	AddMenuItem("@2全部肉合成花灵露("..gn..")个","nc_combine o_mix_book004 f","花灵露合成")
--	else
--	AddMenuItem("全部肉合成花灵露(0)个","nc_combine o_mix_book004 h","花灵露合成")
--end
LuaOtherSendMenu()
return 0 
end
...
if (type=="b")then
	...
	LuaGive("coin",-mon,"Tmixbook")
		...
		LuaLogRecord("合成","o_drug_mp2","物品","获得",1) 
		LuaLogRecord("合成","o_drug_mp2","铜币","消耗",mon) 
	LuaShowNotify("合成花灵露(1)。")
	return 0
	else
...
if (type=="d")then
	...
	LuaGive("coin",-mon,"Tmixbook")
		...
		LuaLogRecord("合成","o_drug_mp2","物品","获得",3) 
		LuaLogRecord("合成","o_drug_mp2","铜币","消耗",mon) 
	LuaShowNotify("合成花灵露(3)。")
	return 0
	else
	LuaShowNotify("合成失败，请检查背包空间！")
	end
...
if (type=="e")then
	...
	LuaGive("coin",-mon,"Tmixbook")
		...
		LuaLogRecord("合成","o_drug_mp2","物品","获得",9) 
		LuaLogRecord("合成","o_drug_mp2","铜币","消耗",mon) 
	LuaShowNotify("合成花灵露(9)。")
	return 0
	else
	LuaShowNotify("合成失败，请检查背包空间！")
	end
...
local tt=b+c+d+e
	...
	LuaGive("coin",-mon*tt,"Tmixbook")
		...
		LuaLogRecord("合成","o_drug_mp2","物品","获得",gn) 
		LuaLogRecord("合成","o_drug_mp2","铜币","消耗",mon*tt)
	LuaShowNotify("合成花灵露("..gn..")。")
	return 0
	else
	LuaShowNotify("合成失败，请检查背包空间！")
	end
