...
other_base = 100,
other = "o_present105:10|o_material_63:10|o_present113:20|o_present112:90"
--other = "o_present045:5|o_present031:8|o_present105:30|o_longyu:20|o_douyuSP:40|o_longyuSP:50"
}
function BossAI(bhp,bmp,EnemyID,hp,mp,level)
 ...
 -----------------------第一阶段
         if(bhp>=90)then
			...
			if(bhp<95 and LuaQueryVar("flag1")==0)then
			BossLocalMsg("杀了你！") ------提示玩家boss进入第二阶段
			LuaSetVar("flag1",1)
			end
  --------------------------第二阶段
         elseif(bhp>=60 and bhp<90) then
			...
			if(bhp<65 and LuaQueryVar("flag2")==0)then
